...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { bizname: @coupon.bizname, code: @coupon.code, desc: @coupon.desc, discount: @coupon.discount }
    end
  ...
  test "should update coupon" do
    put :update, id: @coupon, coupon: { bizname: @coupon.bizname, code: @coupon.code, desc: @coupon.desc, discount: @coupon.discount }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
